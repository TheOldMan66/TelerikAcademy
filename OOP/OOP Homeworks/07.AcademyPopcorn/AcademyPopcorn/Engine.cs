...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        public Engine(IRenderer renderer, IUserInterface userInterface, int sleepTime = 500)
        {
            ...
            this.sleepTime = sleepTime; // TASK 2
        }
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            //TASK 3
            this.allObjects.RemoveAll(item => item.GetType() == typeof(Racket));
            this.staticObjects.RemoveAll(item => item.GetType() == typeof(Racket));
            // end of TASK3
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(sleepTime); // TASK 2
